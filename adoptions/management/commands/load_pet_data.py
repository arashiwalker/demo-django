...
#defining datetime format
DATETIME_FORMAT = '%m/%d/%Y %H:%M'

#hard coding list of vaccines
VACCINES_NAMES = [
    'Canine Parvo',
    'Canine Distemper',
    'Canine Rabies',
